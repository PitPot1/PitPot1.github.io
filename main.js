            ...
            "entries": [
                {
                    ...
                    "image": ["./assets/spirit-thing.png","./assets/ashessmp-1.png","./assets/ashessmp-2.png"],
                    "reviews": [
                        {
                            "author": "Derkz",
                            "stars": 5,
                ...
                },
                {
                    ...
                    "image": ["./assets/cityminer-1.png", "./assets/cityminer-3.png", "./assets/cityminer-2.png", "./assets/CITYMINER.png"]
                },
                {
                    "title": "GenCore",
                    "description": [
            ...
            "entries": [
                {
                    ...
                    "image": ["./assets/level-skript-1.png", "./assets/script1.png", "./assets/level-skript-2.png"],
                    "reviews": [
                        {
                            "author": "perks",
                            "stars": 5,
...
function createEntry(title, img_paths, description, reviews) {
    const entry = document.createElement("div")
    ...
    if (img_paths && img_paths.length > 0) {
        ...
        entry.appendChild(preview_box)
        
        const img_path = img_paths[0];
        const img_e = document.createElement("img")
        img_e.className = "image"
        img_e.src = img_path

        for (let i = 0; i < img_paths.length; i++) {
            const img_preview_path = img_paths[i];
            const img_preview_e = document.createElement("img")
            img_preview_e.className = "image-preview"
            img_preview_e.src = img_preview_path
            img_preview_e.onclick = () => {
                img_e.src = img_preview_path
            }
            preview_box.appendChild(img_preview_e)
        }
